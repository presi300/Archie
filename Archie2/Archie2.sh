...
then 
    ...
    then
        ...
        read k
        pacman -S wayland qtile plasma-wayland-session sddm firefox konsole qt5 networkmanager dolphin bluez bluez-utils noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git kate vlc --noconfirm
    ...
    then
        ...
        echo "Press enter to proceed with installation..."
        read g
        pacman -S wayland qtile gnome-session-wayland gnome-tweaks gdm gnome-nettool gnome-usage adwaita-icon-theme qt5 firefox vlc gedit archlinux-wallpaper gdm gnome-terminal networkmanager gparted git noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra --noconfirm
    ...
    then
        ...
        echo "Press enter to proceed with installation..."
        read x
        pacman -S wayland qtile xfce4 xfce4-goodies lightdm lightdm-gtk-greeter xorg xorg-server firefox networkmanager vlc pulseaudio pavucontrol git noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra --noconfirm
