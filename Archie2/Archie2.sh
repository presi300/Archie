...
then 
    ...
    then
        ...
        read k
        pacman -S wayland plasma-wayland-session plasma-wayland-protocols firefox konsole qt5 networkmanager dolphin bluez bluez-utils noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git kate vlc --noconfirm
    ...
    then
        ...
        echo "Press enter to proceed with installation..."
        read g
        pacman -S wayland gnome-session-wayland gnome-tweaks gnome-nettool gnome-usage adwaita-icon-theme qt5 firefox vlc gedit archlinux-wallpaper gdm gnome-terminal networkmanager gparted git noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra --noconfirm
