...
then 
    ...
    then
        ...
        read k
        pacman -S xorg-xwayland kwin plasma-wayland-session sddm firefox konsole qt5-wayland networkmanager dolphin bluez bluez-utils noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git kate vlc --noconfirm
    ...
    then
        ...
        echo "Press enter to proceed with installation..."
        read g
        pacman -S wayland xorg-server-wayland gnome-session-wayland gnome-tweaks gdm gnome-nettool gnome-usage adwaita-icon-theme qt5 firefox vlc gedit archlinux-wallpaper gdm gnome-terminal networkmanager gparted git noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra --noconfirm
    ...
    then
        ...
        echo "Press enter to proceed with installation..."
        read x
        pacman -S wayland xorg-server-wayland xfce4 xfce4-goodies lightdm lightdm-gtk-greeter xorg xorg-server firefox networkmanager vlc pulseaudio pavucontrol git noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra --noconfirm
...
then
    ...
    echo "What desktop environment would you want:"
    echo "-------------------------------------------------------------------"
    echo "1 - KDE Plasma"plasma-workspace-wayland
    echo "2 - Gnome"
    echo "3 - Xfce"
    echo "4 - Budgie"
