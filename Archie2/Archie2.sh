...
then 
    ...
    then
        ...
        read k
        pacman -S wayland xorg-server-wayland plasma-wayland-session sddm firefox konsole qt5 networkmanager dolphin bluez bluez-utils noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git kate vlc --noconfirm
